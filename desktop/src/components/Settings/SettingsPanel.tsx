...
const PROVIDERS = [
  ...
  { value: 'gemini',     label: 'Google',      abbr: 'G',  url: '' },
  ...
  { value: 'moonshot',   label: 'Moonshot AI', abbr: 'MS', url: 'https://api.moonshot.cn/v1' },
  { value: 'yi',         label: '01.AI',       abbr: '01', url: 'https://api.lingyiwanwu.com/v1' },
  ...
  { value: 'xai',        label: 'xAI',         abbr: 'xI', url: 'https://api.x.ai/v1' },
