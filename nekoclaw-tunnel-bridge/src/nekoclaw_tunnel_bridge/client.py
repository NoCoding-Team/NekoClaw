"""Core tunnel WebSocket client — Python port of openclaw-channel-nekoclaw/src/tunnel-client.ts."""
...
logger = logging.getLogger("nekoclaw_tunnel_bridge")
...
class TunnelClient:
    """Connects to NekoClaw backend WebSocket tunnel, handles auth and message routing."""
    ...
    def __init__(
        ...
        *,
        ...
        api_url = os.environ.get("NEKOCLAW_API_URL", "")
        tunnel_url = os.environ.get("NEKOCLAW_TUNNEL_URL", "")

        self._url = url or tunnel_url or (_derive_tunnel_url(api_url) if api_url else "")
        self._instance_id = instance_id or os.environ.get("NEKOCLAW_INSTANCE_ID", "")
        self._token = token or os.environ.get("NEKOCLAW_TOKEN", "")
